...
namespace Infrastructure.StateMachine.States
{
    public class RoundState : GameState
    {
        ...
        public override async void Enter()
        {
            ...
            _roundHeadsUpDisplay = await _hudFactory.GetRoundHeadsUpDisplay(_health);
            ...
            _enemySpawnerView = await _gameFactory.GetEnemySpawnerView(_enemyConfig, _enemiesContainer, _camera.ViewportToWorldPoint(new Vector3(0.5f,
                    _gameSettingsConfig.EnemySpawnersVerticalPositionOnScreenPercent, _camera.nearClipPlane)), _areasContainer);
            _playerUnit = await _playerFactory.GetPlayerUnit(new PlayerModel(_playerConfig.PlayerSpeed, _playerConfig.AttackRate, _playerConfig.AutomaticAttackRange, playerAreaRightTopPoint, playerAreaLeftDownPoint), _camera.ViewportToWorldPoint(new Vector3(0.5f,
